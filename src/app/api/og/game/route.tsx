	...
	return new ImageResponse(
		(
			...
			>
				...
				<div style={{ position: 'absolute', top: 24, right: 40, fontSize: 28, fontWeight: 600, background: 'linear-gradient(90deg,#6366f1,#ec4899)', WebkitBackgroundClip: 'text', color: 'transparent' }}>{SITE_NAME}</div>
			</div>
		),
